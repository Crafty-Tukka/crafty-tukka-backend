...
if Venue.count == 0
    ...
    Venue.create(name: "Archer Brewing", email: "email@archer.com", password: "123456", -27.4362843, lng: 153.0153557, password_confirmation:"123456", mobile: "61411222334", website: "http://www.archer.com", facebook: "http://facebook.com/archer",description: "Top stuff", google_maps: "https://www.google.com/maps/place/Archer+Brewing+(future+location)/@-27.4362843,153.0153557,15z/data=!4m5!3m4!1s0x0:0x3d436a4dff761c40!8m2!3d-27.4362717!4d153.0152646", address: "Archer Brewing (future location), Newmarket Road, Wilston QLD, Australia")
end
