...
if Event.count == 0
    ...
    Event.create(name: "Burger Night", description: "Come bash a burger and crush an ale", date: Time.strptime('08/10/2022 00:00', '%m/%d/%Y %H:%M'), start_time: Time.strptime('08/10/2022 05:00', '%m/%d/%Y %H:%M'), finish_time: Time.strptime('08/10/2022 06:00', '%m/%d/%Y %H:%M'), truck_id: 3, venue_id: 3, confirmed: true)
end
