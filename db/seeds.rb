...
if Event.count == 0
    ...
    Event.create(name: "Burger Night 2", description: "Come bash a burger and crush an ale!!", date: Time.strptime('08/13/2022 00:00', '%m/%d/%Y %H:%M'), start_time: Time.strptime('08/13/2022 05:00', '%m/%d/%Y %H:%M'), finish_time: Time.strptime('08/13/2022 06:00', '%m/%d/%Y %H:%M'), truck_id: 4, venue_id: 4, confirmed: true)
    Event.create(name: "Hot dogs and hot rods 2", description: "Bring your hot rod down and enjoy some hot dogs and cold brewskies!!!", date: Time.strptime('08/14/2022 00:00', '%m/%d/%Y %H:%M'), start_time: Time.strptime('08/14/2022 03:00', '%m/%d/%Y %H:%M'), finish_time: Time.strptime('08/14/2022 04:00', '%m/%d/%Y %H:%M'), truck_id: 5, venue_id: 5, confirmed: true)
    Event.create(name: "Hot dogs and hot rods 3", description: "Bring your hot rod down and enjoy some hot dogs and cold brewskies!!!!", date: Time.strptime('08/15/2022 00:00', '%m/%d/%Y %H:%M'), start_time: Time.strptime('08/15/2022 03:00', '%m/%d/%Y %H:%M'), finish_time: Time.strptime('08/15/2022 04:00', '%m/%d/%Y %H:%M'), truck_id: 6, venue_id: 6, confirmed: true)
end
